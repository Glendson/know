        ...
        <div class="auth-modal">
            ...
            <input v-if="showSignup" v-model="user.confirmPassword" 
                ...
                <a href @click.prevent="showSignup = !showSignup">
                    <span v-if="showSignup">Já tem cadasto? acesse o login!</span>
                    <span v-else>Não tem cadastro? Clique aqui!</span>
                </a>
        </div>
    </div>
</template>
...
<style>
    ...
    .auth-modal hr{
        ...
        rgba(120, 120, 120, 0), rgba(120, 120, 120, 0.75), rgba(120, 120, 120, 0));
    }
